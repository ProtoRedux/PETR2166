...
{
    public class ChildMealAddonModel : AddonModel
    {
        ...
        public ChildMealAddonModel(TicketModel ticketmodel)
        {
        ...
        public static double CMealPrice { get; } = 3.99;
        ...
        public override string Description => _ticketmodel.Description + " With sausage, chips and soft drink ";
        ...
        {
            return this._ticketmodel.Cost() + CMealPrice;
        }
    }
